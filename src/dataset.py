...
class CapchaDataset(Dataset):
    ...
    def __init__(
        ...
        if '10' not in self.emnist_dataset.classes:
            self.emnist_dataset.classes.append('10')
        self.blank_label = len(self.emnist_dataset.classes) - 1
        self.img_h = img_h
        self.img_w = img_w
        self.samples = samples
        self.num_classes = len(self.emnist_dataset.classes)
